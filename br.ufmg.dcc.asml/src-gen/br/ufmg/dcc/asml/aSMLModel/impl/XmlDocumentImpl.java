 ...
 * <ul>
 *   <li>{@link br.ufmg.dcc.asml.aSMLModel.impl.XmlDocumentImpl#getMatching <em>Matching</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class XmlDocumentImpl extends ConfigurationElementImpl implements XmlDocument
{
  /**
  ...
  {
    return ASMLModelPackage.Literals.XML_DOCUMENT;
  }
  ...
  public void setMatching(String newMatching)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ASMLModelPackage.XML_DOCUMENT__MATCHING, oldMatching, matching));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ASMLModelPackage.XML_DOCUMENT__MATCHING:
        return getMatching();
    }
