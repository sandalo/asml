		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getLayerMatchingClauseAccess().getAlternatives(), "rule__LayerMatchingClause__Alternatives");
					...
					put(grammarAccess.getFrameworkInstantiationAccess().getGroup(), "rule__FrameworkInstantiation__Group__0");
					put(grammarAccess.getFrameworkClassAccess().getGroup(), "rule__FrameworkClass__Group__0");
					put(grammarAccess.getLayerMatchingAccess().getGroup(), "rule__LayerMatching__Group__0");
					...
					put(grammarAccess.getLayerAccess().getGroup_3(), "rule__Layer__Group_3__0");
					...
					put(grammarAccess.getComponentAccess().getMatchingAssignment_3_1(), "rule__Component__MatchingAssignment_3_1");
					put(grammarAccess.getComponentAccess().getCardinalityAssignment_4_1(), "rule__Component__CardinalityAssignment_4_1");
					put(grammarAccess.getComponentAccess().getComponentsAssignment_5(), "rule__Component__ComponentsAssignment_5");
					put(grammarAccess.getComponentAccess().getRestrictionsAssignment_6(), "rule__Component__RestrictionsAssignment_6");
					put(grammarAccess.getFrameworkInstantiationAccess().getNameAssignment_1(), "rule__FrameworkInstantiation__NameAssignment_1");
					put(grammarAccess.getFrameworkInstantiationAccess().getComponentsAssignment_3(), "rule__FrameworkInstantiation__ComponentsAssignment_3");
					put(grammarAccess.getFrameworkInstantiationAccess().getRestrictionsAssignment_4(), "rule__FrameworkInstantiation__RestrictionsAssignment_4");
					put(grammarAccess.getFrameworkClassAccess().getNameAssignment_1(), "rule__FrameworkClass__NameAssignment_1");
					put(grammarAccess.getFrameworkClassAccess().getJavaCLassAssignment_3(), "rule__FrameworkClass__JavaCLassAssignment_3");
					...
					put(grammarAccess.getLayerMatchingAccess().getLayerMatchingAssignment_0(), "rule__LayerMatching__LayerMatchingAssignment_0");
					put(grammarAccess.getLayerMatchingAccess().getParameterAssignment_1(), "rule__LayerMatching__ParameterAssignment_1");
					...
					put(grammarAccess.getClassAccess().getDescriptionAssignment_3_1(), "rule__Class__DescriptionAssignment_3_1");
					put(grammarAccess.getClassAccess().getMatchingAssignment_4_1(), "rule__Class__MatchingAssignment_4_1");
					put(grammarAccess.getClassAccess().getCardinalityAssignment_5_1(), "rule__Class__CardinalityAssignment_5_1");
					put(grammarAccess.getClassAccess().getMethodsAssignment_6(), "rule__Class__MethodsAssignment_6");
					...
					put(grammarAccess.getLayerAccess().getMatchingAssignment_3_1(), "rule__Layer__MatchingAssignment_3_1");
					put(grammarAccess.getLayerAccess().getModulesAssignment_4(), "rule__Layer__ModulesAssignment_4");
					put(grammarAccess.getLayerAccess().getRestrictionsAssignment_5(), "rule__Layer__RestrictionsAssignment_5");
